...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new()
    {
        ...
        Contact = new()
        {
            ...
            Url = new Uri("https://github.com/microsoft/trivia-challenge")
        },
        License = new()
        {
            Name = "MIT License",
            Url = new Uri("https://github.com/microsoft/trivia-challenge/blob/main/LICENSE")
        }
    });
